 ...
 *
 * Displays full details of a selected app including its image, company info,
 * ratings, downloads, description, and allows users to install the app.
 *
 * @component
 *
 * @description
 * The AppDetails component reads the selected app data from React Router's
 * `location.state`, checks installation status from local storage, allows
 * users to install the app, and displays app statistics along with the review chart.
 *
 * @returns {JSX.Element} The rendered App Details page.
 *
 *
 */
          ...
          <div className="flex-3 sm:ml-10 sm:mt-0 mt-10">
            ...
            <div className="mt-8.5 sm:p-0 p-4 text-center sm:text-left">
              <button
                ...
                className={`btn ${
                  !install && 'glitter'
                } bg-[#00d390] text-white rounded shadow-md drop-shadow-2l disabled:!bg-[#00d390] disabled:text-white disabled:opacity-100 disabled:cursor-not-allowed disabled:drop-shadow-xl`}
              >
